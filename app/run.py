...
@app_blueprint.route("/RSVP", methods=["GET", "POST"])
@login_required
def rsvp(guest_df: pd.DataFrame = guest_config):
    ...
    if request.method == "POST":
        ...
        return redirect(url_for("app_blueprint.rsvpform"))

    return temp


@app_blueprint.route("/RSVPForm", methods=["GET", "POST"])
@login_required
def rsvpform(guest_df: pd.DataFrame = guest_config):
    ...
    if request.method == "POST":
        ...
        return redirect(url_for("app_blueprint.thankyou"))

    return temp


@app_blueprint.route("/thankyou")
@login_required
def thankyou() -> str:
    data = {}
